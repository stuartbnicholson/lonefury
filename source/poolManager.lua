...
-- Object pooling
local ASTEROID_POOL_SIZE = 80
local MINE_POOL_SIZE = 30
local MINE_EXPLOSION_POOL_SIZE = 3
local EGG_POOL_SIZE = 10
local ENEMY_POOL_SIZE = 30
local ENEMYBASE_POOL_SIZE = 16
local ENEMYBIGBULLET_POOL_SIZE = 12
local ENEMYBASEZAP_POOL_SIZE = 4
local ENEMYMONSTER_POOL_SIZE = 1
local PLAYERBULLET_POOL_SIZE = 4
